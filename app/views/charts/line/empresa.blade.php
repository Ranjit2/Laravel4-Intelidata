...
<div class="col-md-12">
	<div class="panel panel-default">
		<div class="panel-body">
			<h2 class="text-center">Evolución gasto total mensual</h2>
			<div class="pull-right">
				<a href='{{URL::to("excelEvolucionTotalMensual", Session::get("ses_user_id") ) }}' title="exportar a excel"><i class="fa fa-file-excel-o fa-2x"></i></a>
