	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<h2 class="text-center">Histórico por mes</h2>
				<div class="pull-right">
					<a href="{{ URL::to('/excelHistoricoCategoriaAnual', Session::get('ses_user_id'))}}" id="generaexcel"><i class="fa fa-file-excel-o fa-2x"></i></a>
...
<script type="text/javascript">
	...
	$.loadChart('chartdiv', '/grafHistoricoMes/'+id, 'grafHistoricoMes');
</script>
@stop
