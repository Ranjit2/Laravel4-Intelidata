...
namespace {
	...
	class BoostrapTable extends \Jacopo\Bootstrap3Table\BootstrapTable{
	}
	...
	class PDF extends \Thujohn\Pdf\PdfFacade{
		 ...
		 */
		 public static function __construct(){
			//Method inherited from \Thujohn\Pdf\Pdf
			 \Thujohn\Pdf\Pdf::__construct();
		 }
		 ...
		 */
		 public static function load($html, $size = 'A4', $orientation = 'portrait'){
			//Method inherited from \Thujohn\Pdf\Pdf
			 \Thujohn\Pdf\Pdf::load($html, $size, $orientation);
		 }
		 ...
		 */
		 public static function show($filename = 'dompdf_out', $options = array()){
			//Method inherited from \Thujohn\Pdf\Pdf
			 \Thujohn\Pdf\Pdf::show($filename, $options);
		 }
		 ...
		 */
		 public static function download($filename = 'dompdf_out', $options = array()){
			//Method inherited from \Thujohn\Pdf\Pdf
			 \Thujohn\Pdf\Pdf::download($filename, $options);
		 }
		 ...
		 */
		 public static function output($options = array()){
			//Method inherited from \Thujohn\Pdf\Pdf
			 \Thujohn\Pdf\Pdf::output($options);
		 }
		 ...
		 */
		 public static function clear(){
			//Method inherited from \Thujohn\Pdf\Pdf
			 \Thujohn\Pdf\Pdf::clear();
		 }

	}
	class Velocity extends \Ahir\Velocity\Facades\Velocity{
		/**
		 * Start
		 *
		 * @return null
		 ...
		 */
		 public static function start(){
			//Method inherited from \Ahir\Velocity\Velocity
			return \Ahir\Velocity\Velocity::start();
		 }
		 ...
		 */
		 public static function handle($data){
			//Method inherited from \Ahir\Velocity\Velocity
			 \Ahir\Velocity\Velocity::handle($data);
		 }
		 ...
		 */
		 public static function stop(){
			//Method inherited from \Ahir\Velocity\Velocity
			return \Ahir\Velocity\Velocity::stop();
		 }
		 ...
		 * @static 
		 */
		 public static function sizeToStr($bytes){
			//Method inherited from \Ahir\Velocity\Velocity
			return \Ahir\Velocity\Velocity::sizeToStr($bytes);
		 }
