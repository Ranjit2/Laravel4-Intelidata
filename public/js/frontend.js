...
var data = {
    ...
    datasets: [
        ...
        {   
            ...
            title: "Television",
            fillColor: "rgba(201, 92, 121, 0.6)",
            strokeColor: "rgba(201, 92, 121, 1)",
            pointColor: "rgba(201, 92, 121, 1)",
            pointStrokeColor: "#fff",
            pointHighlightFill: "#fff",
            pointHighlightStroke: "rgba(151,187,205,1)",
            data: [45, 67, 20, 47, 69, 78, 50]
        },
        {   
            label: "My Second dataset",
            title: "Internet",
            fillColor: "rgba(78, 92, 190, 0.6)",
            strokeColor: "rgba(78, 92, 190, 1)",
            pointColor: "rgba(78, 92, 190, 1)",
            pointStrokeColor: "#fff",
            pointHighlightFill: "#fff",
            pointHighlightStroke: "rgba(151,187,205,1)",
